 ...
 @section('meta')
     <meta property="og:image" content="{{ asset('frontend/img/default/png') }}" />
     <meta name="twitter:image" content="{{ asset('frontend/img/default/png') }}">
 @endsection
             ...
             <div class="carousel-inner" role="listbox">
                 @foreach ($banners as $key => $banner)
                     <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                         <img class="first-slide" src="{{ $banner->photo }}" alt="First slide" loading="lazy" decoding="async">
                         ...
                         @if ($cat->is_parent == 1)
                             ...
                             <div class="col-lg-4 col-md-6 col-12">
                                 <div class="single-banner">
                                     @if ($cat->photo)
                                         <img src="{{ $cat->photo }}" alt="{{ $cat->photo }}" loading="lazy" decoding="async">
                                     @else
                                         <img src="{{ asset('frontend/img/default.png') }}" alt="{{ $cat->title }}" loading="lazy" decoding="async">
                                     @endif
                                     <div class="content">
                                         <h3>{{ $cat->title }}</h3>
                                         <a href="{{ route('product-cat', $cat->slug) }}">Explore Now</a>
                                     </div>
                                 </div>
                             </div>
                         @endif
             ...
             <div class="row">
                 <div class="col-12">
                     <div class="product-info">
                         ...
                         <div class="tab-content isotope-grid d-flex" id="myTabContent">
                             <!-- Start Single Tab -->
                             @if ($product_lists)
                                             ...
                                             <div class="product-img">
                                                 <a href="{{ route('product-detail', $product->slug) }}">
                                                     ...
                                                     <img class="default-img" src="{{ $photo[0] }} "
                                                         alt="{{ $photo[0] }}" loading="lazy" decoding="async">
                                             ...
                                             <div class="product-content">
                                                 ...
                                                 <div class="product-price">
                                                     ...
                                                     @if (isset($cookie_rate) && isset($symbol))
                                                         ...
                                                         <del
                                                             style="padding-left:4%;">${{ number_format($product->price / $cookie_rate, $symbol == 'Rs' || $symbol == '₹' ? 2 : 3) }}</del>
                                                     @else
                                                         <span>${{ number_format($after_discount / $user_currency_rate_to_npr, $user_currency_symbol == 'Rs' || $user_currency_symbol == '₹' ? 2 : 3) }}</span>
                                                         <del
                                                             style="padding-left:4%;">${{ number_format($product->price / $user_currency_rate_to_npr, $user_currency_symbol == 'Rs' || $user_currency_symbol == '₹' ? 2 : 3) }}</del>
                                                     @endif
...
@endphp --}}
                     ...
                     @foreach ($featured as $data)
                         ...
                         <div class="col-lg-6 col-md-6 col-12">
                             <div class="single-banner">
                                 ...
                                 @endphp
                                 <img src="{{ $photo[0] }}" alt="{{ $photo[0] }}" loading="lazy" decoding="async">
                                 <div class="content">
    ...
    <p class="price with-discount">
                                                                ${{ number_format($product->discount / $cookie_rate, $symbol == 'Rs' || $symbol == '₹' ? 2 : 3) }}
                                                            </p>
@else
    <p class="price with-discount">
                                                                ${{ number_format($product->discount / $user_currency_rate_to_npr, $user_currency_symbol == 'Rs' || $user_currency_symbol == '₹' ? 2 : 3) }}
                                                            </p>
    @endif -->
                                             </div>
                                         </div>
                                         ...
                                         <div class="quickview-slider-active">
                                             ...
                                             @foreach ($photo as $data)
                                                 <div class="single-slider">
                                                     <img src="{{ $data }}" alt="{{ $data }}" loading="lazy" decoding="async">
                                                 </div>
                                             @endforeach
                                         </div>
                                     </div>
