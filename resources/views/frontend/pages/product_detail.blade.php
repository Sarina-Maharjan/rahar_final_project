 ...
 @section('main-content')
     ...
     <!-- Breadcrumbs -->
     <div class="breadcrumbs py-4 bg-light border-bottom">
         <div class="container">
             <div class="row align-items-center">
                 <div class="col-md-8">
                     <div class="bread-inner">
                         <ul class="bread-list mb-0">
                                     ...
                                     <ul class="slides">
                                         ...
                                         @foreach ($photo as $data)
                                             <li data-thumb="{{ $data }}" rel="adjustX:10, adjustY:">
                                                 <a href="{{ $data }}" data-lightbox="product-gallery"
                                 ...
                                 <div class="short">
                                     ...
                                     @if (isset($cookie_rate) && isset($symbol))
                                         <p class="price"><span class="discount">$.
                                                 {{ number_format($after_discount / $cookie_rate, $symbol == 'Rs' || $symbol == '₹' ? 2 : 3) }}</span><s>$.{{ number_format($product_detail->price / $cookie_rate, $symbol == 'Rs' || $symbol == '₹' ? 2 : 3) }}</s>
                                         </p>
                                     @else
                                         <p class="price"><span class="discount">$.
                                                 {{ number_format($after_discount / $user_currency_rate_to_npr, $user_currency_symbol == 'Rs' || $user_currency_symbol == '₹' ? 2 : 3) }}</span><s>$.{{ number_format($product_detail->price / $user_currency_rate_to_npr, $user_currency_symbol == 'Rs' || $user_currency_symbol == '₹' ? 2 : 3) }}</s>
                                         </p>
                                     @endif
                                     ...
                                     <div class="size mt-4">
                                         ...
                                         <ul>
                                             ...
                                             @foreach ($sizes as $size)
                                                 <li><span class="one">{{ $size }}</span></li>
                                             @endforeach
                                         </ul>
                                     </div>
                                 @endif
                                 ...
                                 <div class="single-product">
                                     ...
                                     <div class="product-content">
                                         ...
                                         <div class="product-price">
                                             ...
                                             @if (isset($cookie_rate) && isset($symbol))
                                                 <span
                                                     class="old">${{ number_format($data->price / $cookie_rate, $symbol == 'Rs' || $symbol == '₹' ? 2 : 3) }}</span>
                                                 <span>${{ number_format($after_discount / $cookie_rate, $symbol == 'Rs' || $symbol == '₹' ? 2 : 3) }}</span>
                                             @else
                                                 <span
                                                     class="old">${{ number_format($data->price / $user_currency_rate_to_npr, $user_currency_symbol == 'Rs' || $user_currency_symbol == '₹' ? 2 : 3) }}</span>
     ...
     <div id="imageModal" class="modal"
         style="display:none; position:fixed; z-index:1050; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.8);">
         <span id="closeModal"
             style="position:absolute; top:20px; right:30px; color:#fff; font-size:30px; cursor:pointer;">&times;</span>
         <img id="modalImage" style="display:block; margin:auto; max-width:90%; max-height:90%; margin-top:5%;">
     </div>
