...
@section('main-content')
    ...
    <!-- Trigger Button -->
    <input type="button" value="Open Filters" class="open-filter-btn btn btn-primary d-lg-none mt-3" data-bs-toggle="modal"
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="quickview-content">
                                        ...
                                        <div class="default-social">
                                            <!-- ShareThis BEGIN -->
                                            <div class="sharethis-inline-share-buttons"></div><!--  END -->
                                        </div>
                                    </div>
                                </div>
                            </div>
