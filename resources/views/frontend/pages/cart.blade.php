                                        ...
                                        <tr>
                                            ...
                                            @if (isset($cookie_rate) && isset($symbol))
                                                <td class="price" data-title="Price">
                                                    <span>${{ number_format($cart['price'] / $cookie_rate, $symbol == 'Rs' || $symbol == '₹' ? 2 : 3) }}</span>
                                                </td>
                                            @else
                                                <td class="price" data-title="Price">
                                                    <span>${{ number_format($cart['price'] / $user_currency_rate_to_npr, $user_currency_symbol == 'Rs' || $user_currency_symbol == '₹' ? 2 : 3) }}</span>
                                                </td>
                                            @endif
                                            ...
                                            @if (isset($cookie_rate) && isset($symbol))
                                                <td class="total-amount cart_single_price" data-title="Total"><span
                                                        class="money">${{ $cart['amount'] / $cookie_rate }}</span>
                                                </td>
                                            @else
                                                <td class="total-amount cart_single_price" data-title="Total"><span
                                                        class="money">${{ $cart['amount'] / $user_currency_rate_to_npr }}</span>
                                                </td>
                                            @endif
                                ...
                                <div class="right">
                                    <ul>
                                        <li class="order_subtotal" data-price="{{ Helper::totalCartPrice() }}">Cart
                                            Subtotal
                                            @if (isset($cookie_rate) && isset($symbol))
                                                <span>${{ number_format(Helper::totalCartPrice() / $cookie_rate, $symbol == 'Rs' || $symbol == '₹' ? 2 : 3) }}</span>
                                            @else
                                                <span>${{ number_format(Helper::totalCartPrice() / $user_currency_rate_to_npr, $user_currency_symbol == 'Rs' || $user_currency_symbol == '₹' ? 2 : 3) }}</span>
                                            @endif
                                        </li>
                                        ...
                                        @if (session()->has('coupon'))
                                            <li class="coupon_price" data-price="{{ Session::get('coupon')['value'] }}">You
                                                ...
                                                @if (isset($cookie_rate) && isset($symbol))
                                                    <span>
                                                        ${{ number_format(Session::get('coupon')['value'] / $cookie_rate, $symbol == 'Rs' || $symbol == '₹' ? 2 : 3) }}
                                                    </span>
                                                @else
                                                    <span>
                                                        ${{ number_format(Session::get('coupon')['value'] / $user_currency_rate_to_npr, $user_currency_symbol == 'Rs' || $user_currency_symbol == '₹' ? 2 : 3) }}</span>
                                                @endif
                                            </li>
                                        @endif
                                        @php
                                        ...
                                        @if (session()->has('coupon'))
                                            <li class="last" id="order_total_price">You
                                                Pay
                                                @if (isset($cookie_rate) && isset($symbol))
                                                    <span>${{ number_format($total_amount / $cookie_rate, $symbol == 'Rs' || $symbol == '₹' ? 2 : 3) }}</span>
                                                @else
                                                    <span>${{ number_format($total_amount / $user_currency_rate_to_npr, $user_currency_symbol == 'Rs' || $user_currency_symbol == '₹' ? 2 : 3) }}</span>
                                                @endif
                                            </li>
                                        @else
                                            <li class="last" id="order_total_price">You
