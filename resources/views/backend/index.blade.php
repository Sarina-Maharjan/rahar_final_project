...
@section('title','Thangka Store || DASHBOARD')
                ...
                var myLineChart = new Chart(ctx, {
                  ...
                  data: {
                    ...
                    datasets: [{
                      ...
                      borderColor: "rgba(141, 0, 47, 1))",
                      pointRadius: 3,
                      pointBackgroundColor: "rgba(141, 0, 47, 1)",
                      pointBorderColor: "rgba(141, 0, 47, 1)",
                      pointHoverRadius: 3,
                      pointHoverBackgroundColor: "rgba(141, 0, 47, 1)",
                      pointHoverBorderColor: "rgba(141, 0, 47, 1)",
                      pointHitRadius: 10,
                      pointBorderWidth: 2,
