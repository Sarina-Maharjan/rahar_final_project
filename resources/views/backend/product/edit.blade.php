...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
       ...
       <div class="form-group">
  <label for="size" class="col-form-label">Size(s) <span class="text-danger">*</span></label>
  <input id="size" type="text" name="size" placeholder="Enter size" value="{{ old('size', $product->size) }}" class="form-control">
  @error('size')
  <span class="text-danger">{{ $message }}</span>
  @enderror
</div>
